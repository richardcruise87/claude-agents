...
echo "   - $REPO_DIR/ci-failure-agent/config.json"
echo "   - $REPO_DIR/bug-reproduction-agent/config.json"
echo ""
echo "2. Enable and start timers:"
echo -e "   ${BLUE}systemctl --user enable octavia-bug-triage.timer${NC}"
echo -e "   ${BLUE}systemctl --user start octavia-bug-triage.timer${NC}"
echo ""
echo -e "   ${BLUE}systemctl --user enable octavia-code-review.timer${NC}"
echo -e "   ${BLUE}systemctl --user start octavia-code-review.timer${NC}"
echo ""
echo -e "   ${BLUE}systemctl --user enable octavia-ci-failure.timer${NC}"
echo -e "   ${BLUE}systemctl --user start octavia-ci-failure.timer${NC}"
echo ""
echo "3. Enable and start bug reproduction path watcher (event-driven):"
echo -e "   ${BLUE}systemctl --user enable octavia-bug-reproduction.path${NC}"
echo -e "   ${BLUE}systemctl --user start octavia-bug-reproduction.path${NC}"
echo ""
echo "4. Check timer/path status:"
echo -e "   ${BLUE}systemctl --user list-timers octavia-*${NC}"
echo -e "   ${BLUE}systemctl --user status octavia-bug-reproduction.path${NC}"
echo ""
echo "5. Run services manually (for testing):"
echo -e "   ${BLUE}systemctl --user start octavia-bug-triage.service${NC}"
echo -e "   ${BLUE}systemctl --user start octavia-code-review.service${NC}"
echo -e "   ${BLUE}systemctl --user start octavia-ci-failure.service${NC}"
echo -e "   ${BLUE}systemctl --user start octavia-bug-reproduction.service${NC}"
echo ""
echo "6. View logs:"
echo -e "   ${BLUE}journalctl --user -u octavia-bug-triage.service -f${NC}"
echo -e "   ${BLUE}journalctl --user -u octavia-code-review.service -f${NC}"
echo -e "   ${BLUE}journalctl --user -u octavia-ci-failure.service -f${NC}"
echo -e "   ${BLUE}journalctl --user -u octavia-bug-reproduction.service -f${NC}"
echo ""
echo "7. Enable user services to start at boot:"
echo -e "   ${BLUE}loginctl enable-linger $USER${NC}"
echo ""
echo "=============================================="
