...
class ForgeClient:
    ...
    def post_feedback(
        ...
        Args:
            ...
            extra_labels:  Additional Gerrit label votes to set alongside the
                           primary Code-Review vote (e.g. {"Backport-Candidate": 1}).
                           Ignored by GitHub and GitLab implementations.
...
class GitHubClient(ForgeClient):
    ...
    def post_feedback(
        ...
        if extra_labels:
            print("   ℹ️  extra_labels not supported for GitHub — skipping label votes")
...
class GitLabClient(ForgeClient):
    ...
    def post_feedback(
        ...
        if extra_labels:
            print("   ℹ️  extra_labels not supported for GitLab — skipping label votes")
